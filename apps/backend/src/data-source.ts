...
import { AddSurfaceReadingModelVersion1715200000000 } from './migrations/1715200000000-AddSurfaceReadingModelVersion.js';
...
export const AppDataSource = new DataSource({
  ...
  migrations: [
    ...
    AddSurfaceReadingModelVersion1715200000000,
  ],
  synchronize: false,
});
