 ...
 * via `@RequireFeature`), and `SystemSwitchGuard` (operator kill-switch
...
@Module({
  ...
  providers: [FeatureResolver, FeatureGuard, SystemSwitchGuard],
  exports: [FeatureResolver, FeatureGuard, SystemSwitchGuard],
})
