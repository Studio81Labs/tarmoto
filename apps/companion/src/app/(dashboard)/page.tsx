    ...
    <div className="p-6 max-w-6xl mx-auto space-y-8 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-slate-400 mt-1">
          {t("Here's what's happening on your roads.")}
        </p>
      </div>
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold">{t("Recent rides")}</h2>
          <Link
            href="/rides"
            className="text-sm text-tarmoto-cyan hover:underline flex items-center gap-1"
          >
            {t("View all ")}
            <ArrowRight size={14} />
          </Link>
        ...
        <div className="rounded-2xl bg-slate-900 border border-slate-800 p-12 text-center">
          ...
          <p className="text-slate-400">{t("No rides recorded yet.")}</p>
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold">{t("Your trips")}</h2>
          <Link
            href="/trips/planner"
            className="text-sm text-tarmoto-cyan hover:underline flex items-center gap-1"
          >
        ...
        <div className="rounded-2xl bg-slate-900 border border-slate-800 p-12 text-center">
          ...
          <p className="text-slate-400">{t("No trips planned yet.")}</p>
          <p className="text-sm text-slate-500 mt-1">
            {t("Create your first trip to discover the best roads.")}
          </p>
        </div>
      </section>
    </div>
