  ...
  return (
    <div className="p-6 max-w-3xl mx-auto animate-fade-in">
      ...
      <div className="space-y-6">
        {[
          { label: 'Profile visibility', description: 'Who can see your profile and riding stats', options: ['Public', 'Riders only', 'Private'], defaultIndex: 1 },
          { label: 'Default ride sharing', description: 'How new rides are shared by default', options: ['Public', 'Private'], defaultIndex: 1 },
          { label: 'Road data contribution', description: 'Share accelerometer data to improve road quality maps for all riders', options: ['Enabled', 'Disabled'], defaultIndex: 0 },
        ].map((setting) => (
          <div key={setting.label} className="rounded-xl bg-slate-900 border border-slate-800 p-5">
            <div className="flex items-start justify-between">
              ...
              <select
                defaultValue={setting.defaultIndex}
