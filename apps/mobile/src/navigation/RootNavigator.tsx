...
function MapNavigator() {
  return (
    <MapStack.Navigator screenOptions={screenOptions}>
      ...
      <MapStack.Screen name="RoadPreview" component={RoadPreviewScreen} options={{ title: 'Road Preview' }} />
    </MapStack.Navigator>
  );
}
...
function RideNavigator() {
  return (
    <RideStack.Navigator screenOptions={screenOptions}>
      <RideStack.Screen name="RideStart" component={RideScreen} options={{ headerShown: false }} />
      <RideStack.Screen name="RideActive" component={RideActiveScreen} options={{ headerShown: false }} />
      <RideStack.Screen name="HazardReport" component={HazardReportScreen} options={{ title: 'Report Hazard', presentation: 'modal' }} />
    </RideStack.Navigator>
  );
}
...
function TripsNavigator() {
  return (
    <TripsStack.Navigator screenOptions={screenOptions}>
      ...
      <TripsStack.Screen name="TripCreate" component={TripCreateScreen} options={{ title: 'Plan a Trip' }} />
      <TripsStack.Screen name="TripDetail" component={TripDetailScreen} options={{ title: 'Trip' }} />
      <TripsStack.Screen name="TripDay" component={TripDayScreen} options={{ title: 'Day Route' }} />
      <TripsStack.Screen name="RoadPreview" component={RoadPreviewScreen} options={{ title: 'Road Preview' }} />
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Tab.Screen name="RideTab" component={RideNavigator} options={{ tabBarLabel: 'Ride' }} />
        <Tab.Screen name="TripsTab" component={TripsNavigator} options={{ tabBarLabel: 'Trips' }} />
