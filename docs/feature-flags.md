...
| `advanced_ride_stats`    | toggle (Pro)                    | **SP1** — lean/elevation nulled on the ride list + detail + rename responses AND the CSV export columns for a non-entitled viewer                                                                                                                   | ⏳ SP2 — hide the advanced-stats section + upsell                         |
