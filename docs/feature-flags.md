...
>
> It still ships **dark**: the launch overrides make every rider resolve
> unlimited **unless a more-restrictive per-user override exists** (support-set
> per-user exceptions survive the global clamp). See
