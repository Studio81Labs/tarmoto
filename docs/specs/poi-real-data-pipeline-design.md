...
| `pois` **PostGIS store** + weekly BullMQ importer (#745) | **Built but dormant** (`TARMOTO_POI_IMPORT_ENABLED=false`); **table is write-only, nothing reads it** | _(as of the POI-ingestion extraction, T1–T7)_ `packages/poi-db/src/entities/poi.entity.ts`, `packages/poi-db/src/migrations/1787000000000-AddPois.ts`, `apps/ingest/src/poi/poi-import.service.ts`, `modules/jobs/*` (queue `poi.import`, `WEEKLY_SUN_0300`) |
