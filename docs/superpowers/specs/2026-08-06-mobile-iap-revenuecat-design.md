...
| 4.5  | **Provisioning spike to answer (f) — and now also step 6.5's Google cancellation mechanism** — RevenueCat project, Play products with two plans, throwaway internal-testing build, one plan upgrade observed. **Skip if RevenueCat support answers first.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | **next** — not started                         |
