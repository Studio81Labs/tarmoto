...
> unbounded one.
>
> **One deliberate exception: `revenuecat_app_user_id`, held only until erasure
...
> here.** Each §12 row is a second copy of a decision argued somewhere in §4–§8:
