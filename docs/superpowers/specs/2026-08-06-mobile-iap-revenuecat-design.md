...
| 4.9  | **Store subscription chains — the multi-chain storage move. Added 2026-08-12; BLOCKS step 5.** Design: `docs/superpowers/specs/2026-08-12-store-subscription-chains-design.md`. Expand (create `store_subscriptions` + indexes, vacuous backfill) → readers (`resolveEntitledTier` derives from the live set; store writers dual-write) → contract (drop `apple_original_transaction_id` / `google_original_transaction_id` and their unique indexes). **This must precede the consumer**: building step 5 against the retired single-slot guard would produce a claim path that rejects a legitimate Play plan upgrade and then have to be rewritten. Also carries the deterministic response projection and the multi-chain account-deletion enumeration the design specifies.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | **not started — blocks step 5**                                                                                                                |
