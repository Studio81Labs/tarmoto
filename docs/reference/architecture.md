...
Operational playbooks (rollback per platform, secret rotation) live in [../process/runbook.md](../process/runbook.md#production-deploys).
...
Workflows: [`backend-deploy.yml`](../../.github/workflows/backend-deploy.yml) (triggers the Coolify deploy API, tracks the deployment to completion, runs smoke test, surfaces manual rollback instructions on failure), [`companion-deploy.yml`](../../.github/workflows/companion-deploy.yml) (staging + production), [`mobile-release.yml`](../../.github/workflows/mobile-release.yml) (TestFlight + Play Internal). Post-deploy verification is `scripts/smoke/smoke.sh`.
