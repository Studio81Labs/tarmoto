...
Workflows: [`backend-deploy.yml`](../../.github/workflows/backend-deploy.yml) (waits for the PaaS deploy, runs smoke test, rolls back via the PaaS API on failure), [`companion-deploy.yml`](../../.github/workflows/companion-deploy.yml) (PR previews + staging + production), [`mobile-release.yml`](../../.github/workflows/mobile-release.yml) (TestFlight + Play Internal). Post-deploy verification is `scripts/smoke/smoke.sh`.
