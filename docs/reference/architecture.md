...
| `road.import`               | weekly Sun `0 1 * * 0`                    | Imports the configured OSM `.osm` extract into `road_segments` (#781), ahead of POI import + fun-zones. Dormant until `TARMOTO_OSM_ROAD_IMPORT_ENABLED=true`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
