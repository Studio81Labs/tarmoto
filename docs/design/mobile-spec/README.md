...
| `RideScreen` (turn-by-turn HUD)            | `NavigationScreen` ✅, `RideActiveScreen`                                                                                      | Always-dark immersive HUD (brand **night palette**). `NavigationScreen` migrated with its `WeatherAlertBanner`; `RideActiveScreen` remains. |
